...
resource "aws_instance" "tf-docker-ec2" {
    ...
    key_name = "firstkey"
    security_groups = ["Kevser-docker-sec-gr-203"] # !!!!!!!!!!!!
    tags = {
        Name = "Kevser-Web Server of Bookstore"
    }
    user_data = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          FOLDER="https://$TOKEN@raw.githubusercontent.com/F4455-Kevser/Docker-Projects/main/"
